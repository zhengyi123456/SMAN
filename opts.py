...
def parse_opt():
    ...
    parser.add_argument('--noamopt_warmup', type=int, default=0)
    ...
    parser.add_argument('--input_box_feature', type=str, default='data/msvtt_box_features.h5')
    parser.add_argument('--input_c3d_feature', type=str, default='data/msvtt_c3d_features.h5')
    parser.add_argument('--input_app_feature', type=str, default='data/msvtt_appearance_features.h5')
    # Model Settings
